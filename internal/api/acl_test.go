...
func (s *fakeACLProjectStore) UpdateSourceRevisionPageCount(_ context.Context, _ string, _ string, _ int, _ int) error {
	return nil
}
func (s *fakeACLProjectStore) DeleteSourceRevision(_ context.Context, _ string, _ string, _ int) error {
	return nil
}
func (s *fakeACLProjectStore) UpdateSourceRevisionDisplayName(_ context.Context, _ string, _ string, _ int, _ string) error {
	return nil
}
